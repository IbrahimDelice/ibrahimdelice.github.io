...
Bu örnekte de `-t-`, „kopartırmıştır‟ kullanımının söyleme zorluğunu gidermek -yani, fiil tabanı ile `-tIr-` ettirgenlik ekini kaynaştırmak için kullanılmıştır. Bu fiilin aslı, “- Niçin beni yalancı çıkardın? dedim. Musluğu sen koparmamıştın....” (Ö. Seyfettin) örneğinde olduğu gibi "koparmak"tır.  
